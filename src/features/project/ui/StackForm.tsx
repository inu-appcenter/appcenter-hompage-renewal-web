...
import { Check, Code2, Layers, Plus, Search, X } from 'lucide-react';
...
export const StackForm = ({ form, setForm }: { form: IntroduceForm; setForm: React.Dispatch<React.SetStateAction<IntroduceForm>> }) => {
  const { data: skillStack } = useSkillStack();
          ...
          <div className="flex h-150 w-200 max-w-full flex-col">
            ...
            <div className="custom-scrollbar flex-1 overflow-y-auto px-1 py-4">
              {filteredStack.length > 0 ? (
                ...
                <div className="flex h-60 w-full flex-col items-center justify-center gap-2 text-slate-400">
